...
@Component({
  selector: 'app-use-helper-methods-to-setup',
  standalone: true,
  imports: [],
  templateUrl: './use-helper-methods-to-setup.component.html',
  styleUrl: './use-helper-methods-to-setup.component.css'
})
export class UseHelperMethodsToSetupComponent {
